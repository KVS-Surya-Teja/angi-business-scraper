...
# HTML form with dropdowns and input for city
html_form = '''
<!DOCTYPE html>
<html lang="en">
<head>
...
def submit():
    ...
    return f"Category: {a}, State: {b}, City: {c}"

def open_browser():
    """Automatically open the default browser with the Flask app."""
